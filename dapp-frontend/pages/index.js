...
import { NFT_CONTRACT_ADDRESS } from "../constants/contract";
import data from "../constants/CryptoDevs.json";
const abi = data.abi;
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (!walletConnected) {
      ...
      const tokensMintedInterval = setInterval(async function () {
        let tokensMinted = await getTokenIdsMinted();
        if (tokensMinted == 20) {
          clearInterval(tokensMintedInterval);
        }
      }, 5 * 1000);
    }
  }, [walletConnected]);
